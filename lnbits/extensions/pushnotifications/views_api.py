...
async def api_subscription_create(
    ...
    for wallet_id in wallet_ids:
        new_subscription = await create_subscription(endpoint, wallet_id, data.subscription, host)
...
async def api_delete_subscription(
    ...
    endpoint = unquote(base64.b64decode(request.query_params.get("endpoint")).decode("latin1"))
