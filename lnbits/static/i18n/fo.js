window.localisation.fo = {
  ...
  credit_hint: 'Trýst á Enter til tess at góðskriva/skuldskriva mappu (negativ viðri eru loyvd)',
  ...
  export_to_phone_desc: 'QR-kotan inniheldur eina leinkju ið vísir til og gevur full rættindi til tína mappu. Skannar tú hana, t.d. við tíni snildfon, kanst tú lata upp mappu nýtaramótið har.',
  ...
  delete_wallet_desc: 'Mappan verður strikað og peningurin í henni fæst IKKI AFTUR.',
  ...
  claim_desc: 'Tú tykist hava krav á einari bitcoin upphædd men hevur ikki eina mappu enn. Trýst á knøttin niðanfyri fyri at taka ímóti henni. Ein nýggj mappa verður gjørd tær.',
  ...
  drain_funds_desc: 'Hendan LNURL-úttøku QR-kotan kann brúkast at taka allan peningin úr mappuni. Ikki deila QR-kotuna við nakran. Hon ger nýtslu av balanceCheck og balanceNotify og kann tí brúkast fleiri ferðir at tøma mappuna.',
  ...
  ext_sources_label: 'Kelduleinkja (brúka einans almennu LNbits-ískoytisforritakelduna og keldur tú hevur álit á)',
  warning: 'Gev gætur',
  repository: 'Kelda',
  ...
  faucest_wallet_desc_2: 'Hetta hjálpir at halda skil á øllum {provider} gjøldum og støðum teirra.',
  ...
  phoenixd_warning: "Phoenixd áminningarramsan kann einans ásetast um phoenixd dátuskjáttan er ásett og LNbits fær lisið hana. Tað er ikki eitt tekin um at phoenixd ikki koyrir. Tað merkir bara at LNbits ikki hevur atgongd at vísa áminningarramsuna her.",
  ...
  notification_balance_delta_changed_desc: 'Boða frá tá munurin á knútasalduni og LNbits-salduni er broyttur meira enn tað ávístu upphæddina (í sats). Áset 0 fyri at óvirkja. Verður kannað hvønn minutt.',
  ...
  callback_url_rule_hint: 'Afturtøkukallleinkjur, harímillum LNURL-leinkjur, verða kannaðar sambært hesum reglunum. Í minsta lagi ein regla skal lúkast. Eru ongar reglur skrásettir eru allar leinkjur loyvdar.',
  ...
  extension_permissions_high_risk_warning: 'Hetta ískoytisforritið biður um rættindi at flyta pening.',
  ...
  toggle_transactions_node_ui: 'Flytingarskiljiblað (frámælt á størri CLN-knútum vegna ovbyrjan)',
  ...
  payment_wait_time_desc: 'Bíðitíð áðrenn útgjøld verða merkt at verða í bíðistøðu. Forsett: 5 sek.; hækka í fall gjaldsumbønirnar taka langa tíð at avroknað.',
  ...
  ui_toggle_elements_tip: "Strikar lutir so sum LNbits-útgávu og 'Koyrir á' frá forsíðuni",
