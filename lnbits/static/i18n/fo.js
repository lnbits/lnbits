window.localisation.fo = {
  ...
  service_fee_tooltip: 'Tænastuavgjald ið LNbits-ambætaraumsitarin krevur fyri hvørt útgjald',
  ...
  webhook_stripe_description: 'Á Stripe síðuni noyðist tú at uppseta ein vevongul við einari leinkju ið peikar á tín LNbits-ambætara.',
  webhook_square_description: 'Á Square síðuni noyðist tú at uppseta ein vevongul ið peikar á hesa LNbits-leinkjuna.',
  square_webhook_url_hint: 'Skal samsvara við fráboðanarleinkjuna hjá Square. LNbits tørvar /api/v1/callback/square slóðina.',
  access_token: 'Atgongdarmerki',
  location_id: 'Staðsetingareyðmerki',
  square_location_id_hint: 'Square-staðsetingareyðmerkið ið gjaldsumbønarleinkjur verða gjørdar fyri. Brúka endapunktið at velja royndar- ella framleiðsluumhvørvi.',
  ...
  email_confirmation_hint: 'Teldupostbústaður ið váttanarkota skal sendast til.',
  nostr_identifier: 'Nostr-dátuheiti',
  nostr_identifier_hint: 'Nostr nip5-dátuheiti ella <npub> ið váttanarkota skal sendast til.',
  first_name: 'Fornavn',
  last_name: 'Eftirnavn',
  picture: 'Mynd',
  ...
  extension_permissions_none: 'Hetta ískoytisforritið krevur ongi rættindir undir innlegging.',
  user_permissions_none: 'Tú hevur ikki játtað hesum ískoytisforriti nøkur rættindir.',
  user_permissions_max_amount: 'Mark á gjaldsupphædd',
  user_permissions_destination_policy: 'Loyvi at rinda til',
  user_permissions_no_editable_settings: 'Hendan játtanin hevur einki at tillaga.',
  extension_permissions_grant_install: 'Játta og innlegg',
  extension_permissions_high_risk_warning: 'Hettar ískoytisforritið biður um rættindi at flyta pening.',
  ...
  extension_permission_warning_wallet_pay_invoice: 'Kann brúka pening úr mappum ið eru tøkar á tínum brúkara.',
  extension_permission_warning_wallet_pay_invoice_background: 'Kann brúka pening úr ásettum mappum seinni og uttan inntriv frá brúkara.',
  extension_permission_warning_wallet_payments_watch: 'Kann lesa gjaldssmálutir viðvíkjandi ásettum mappum.',
  extension_permission_warning_extension_api_request_write: 'Kann skriva dátur ella koyra tilgongdir í ásettum ískoytisforritum.',
  extension_permission_ext_storage_read: 'Lesa ískoytisforritagoymslu',
  extension_permission_ext_storage_read_public: 'Lesa almenna ískoytisforritagoymslu',
  extension_permission_ext_storage_write: 'Skriva til ískoytisforritagoymslu',
  extension_permission_ext_storage_read_write: 'Lesa og skriva til ískoytisforritagoymslu',
  ...
  extension_permission_wallet_create_invoice_public: 'Gera Lightning-gjaldsumbønir frá almennum síðum',
  ...
  extension_permission_wallet_pay_invoice_background: 'Rinda í bakgrundini, uttan inntriv frá brúkara',
  ...
  routing_fee_reserve_calculations_desc: 'Fyri hvørt útgjald setur LNbits eina "tiltaksupphædd" til síðis at rinda beiningaravgjøld. Hámarkið á beiningaravgjaldinum ið verður handað fíggingarkelduni er tað hægra av fylgjandi: <strong>lágmarkið fyri beiningaravgjald</strong> ella <strong>beiningaravgjald í prosentum</strong>.',
  millisats: 'millisats',
  fee_reserve: 'Lágmark fyri beiningaravgjald',
  fee_reserve_percent: 'Beiningaravgjald í prosentum',
  fee_reserve_min_hint: 'Lágmark fyri beiningariavgjald fyri hvørt gjald.<br>Hetta riggar sum eitt minstamark - mest loyvda beiningaravgjald verður ongantíð lægri, uttan mun til gjaldsupphæddina.',
  fee_reserve_percent_hint: 'Prosent av gjaldsupphæddini at seta av til beiningaravgjald.',
  ...
  auth_oidc_ci_hint: 'Tryggja at samgildisafturtøkukallsleinkjan er sett til https://{domain}/api/v1/auth/oidc/token',
  auth_oidc_cs_label: 'OIDC-viðskiftaraloyna',
  auth_oidc_custom_org_label: 'Tillaga OIDC navn á felagi (t.d. Zitadel, Authentik)',
  ...
  square_webhook_signature_key_hint: 'Square-vevongulsundirritanarlykil ið váttar inngandi hendingar.',
