  ...
  <q-card-section class="q-pa-none">
    ...
    <div class="row">
      <div class="col">
        <q-list bordered class="rounded-borders">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                      <q-input
                        ...
                        class="q-ma-sm"
                        v-model="
                          formData.stripe_limits.service_faucet_wallet_id
                        "
                        @update:model-value="formData.touch = null"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                      <q-input
                        ...
                        class="q-ma-sm"
                        v-model="
                          formData.paypal_limits.service_faucet_wallet_id
                        "
                        @update:model-value="formData.touch = null"
                        :label="$t('faucest_wallet_id')"
                        :hint="$t('faucest_wallet_id_hint')"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                      <q-input
                        ...
                        class="q-ma-sm"
                        v-model="
                          formData.square_limits.service_faucet_wallet_id
                        "
                        @update:model-value="formData.touch = null"
                        :label="$t('faucest_wallet_id')"
                        :hint="$t('faucest_wallet_id_hint')"
          ...
          <q-expansion-item header-class="text-primary text-bold">
            ...
            <q-card class="q-pb-xl">
              ...
              <q-expansion-item :label="$t('webhook')" default-opened>
                <q-card-section>
                  Configure a Revolut Merchant webhook that points to your
                  LNbits server. LNbits will create it through the Revolut API
                  and subscribe to <code>ORDER_AUTHORISED</code>,
                  ...
                  <div class="row">
                    <div class="col-md-4 col-sm-12">
                      <q-input
                        ...
                        min="0"
                        v-model="
                          formData.revolut_limits.service_min_amount_sats
                        "
                        :suffix="$t('sats')"
                        @update:model-value="formData.touch = null"
                        :label="$t('min_incoming_payment_amount')"
                    ...
                    <div class="col-md-4 col-sm-12">
                      <q-input
                        ...
                        min="0"
                        v-model="
                          formData.revolut_limits.service_max_amount_sats
                        "
                        :suffix="$t('sats')"
                        @update:model-value="formData.touch = null"
                        :label="$t('max_incoming_payment_amount')"
                    ...
                    <div class="col-md-4 col-sm-12">
                      <q-input
                        ...
                        class="q-ma-sm"
                        v-model="
                          formData.revolut_limits.service_faucet_wallet_id
                        "
                        @update:model-value="formData.touch = null"
                        :label="$t('faucest_wallet_id')"
                        :hint="$t('faucest_wallet_id_hint')"
        ...
        <h6 class="q-my-none q-mb-sm">Provider Capabilities</h6>
        <div
