...
class Wallet(ABC):
    ...
    @abstractmethod
    async def pay_offer(self, offer: str, fee_limit_msat: int) -> PaymentResponse:`n        raise InvoiceError(message="BOLT12 offers are not supported by this wallet.", status="failed")`n`n    @abstractmethod`n    def pay_invoice(
