...
async def m052_fiat_balances_view(db: Connection):
    """Reserved for databases that applied the retired development fiat view."""


async def m053_integer_fiat_amounts(db: Connection):
    """Reserved for the deferred fiat accounting optimisation.

    Existing columns and views are left unused; receipts retain their original extra.
    """
