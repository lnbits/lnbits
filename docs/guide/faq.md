...
<details><summary>Which funding sources can I use for LNbits?</summary>
  ...
  <p>The <a href="http://docs.lnbits.org/guide/wallets.html">LNbits manual</a> shows you which sources can be used and how to configure each: CLN, LND, LNPay, OpenNode as well as bots.</p>
</details>
